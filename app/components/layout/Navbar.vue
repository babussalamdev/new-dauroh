<template>
  <nav 
    class="fixed-navbar navbar navbar-expand-lg navbar-light py-3 sticky-top"
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center gap-3">
          ...
          <li class="nav-item" v-if="!isLoggedIn">
             <div class="d-flex align-items-center gap-3">
                <NuxtLink class="nav-link text-dark fw-medium" to="/login">Login</NuxtLink>
                <NuxtLink to="/register" class="btn btn-primary px-4 rounded-pill">Buat Akun</NuxtLink>
             </div>
          </li>

          <li class="nav-item dropdown" v-if="isLoggedIn">
              <button class="btn btn-light rounded-pill dropdown-toggle d-flex align-items-center gap-2" type="button" data-bs-toggle="dropdown" aria-expanded="false">
