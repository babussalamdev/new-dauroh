<template>
  <div class="text-center py-5 animate-fade-in">
    ...
    <p class="text-muted mb-4">
      ...
      <strong class="text-primary">{{ store.event?.Title }}</strong> telah terkonfirmasi.
    </p>
    ...
    <ModalsQrCodeModal v-if="showQrModal" :show="showQrModal" :ticket="ticketData" @close="showQrModal = false" />
