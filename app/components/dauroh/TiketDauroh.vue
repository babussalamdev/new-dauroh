...
@media (min-width: 768px) { /* Medium screens (md) - 3 cards */
  .dauroh-card-wrapper {
    /* (100% / 3) - (gap * (n-1) / n ) */
    width: calc(33.333% - (1rem * 2 / 3) - 4px); /* Kurangi beberapa pixel lagi */
  }
}
@media (min-width: 992px) { /* Large screens (lg) - 4 cards */
  .dauroh-card-wrapper {
     /* (100% / 4) - (gap * (n-1) / n ) */
...
@media (max-width: 991.98px) { /* Sembunyikan tombol di bawah lg */
  .carousel-control-prev, .carousel-control-next {
     display: none;
   }
   .carousel {
...
.skeleton-container .card.dauroh-card { height: 100%; }
