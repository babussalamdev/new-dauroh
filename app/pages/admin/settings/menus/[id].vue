    ...
    <nav aria-label="breadcrumb" class="mb-4">
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <NuxtLink to="/admin" class="text-decoration-none txt-caption text-primary">Home</NuxtLink>
        </li>
        <li class="breadcrumb-item">
          <NuxtLink to="/admin/settings/menus" class="text-decoration-none txt-caption text-primary">Control Menu</NuxtLink>
        </li>
        <li class="breadcrumb-item active txt-caption text-dark fw-bold" aria-current="page">Sub Menu</li>
      </ol>
    </nav>
