    ...
    <div class="card content-card">
      ...
      <div class="card-header d-flex justify-content-between align-items-center bg-white py-3">
        <div class="d-flex align-items-center gap-3">
          ...
          <select class="form-select form-select-sm" style="width: 250px; border-color: #009B4D;"
            v-model="store.selectedEventSK" @change="store.fetchVouchers()">
              ...
              <tbody>
                <tr v-for="v in store.voucher" :key="v.SK">
                  ...
                  <td class="text-center pe-4">
                    <button class="btn btn-danger btn-sm rounded" style="width: 32px; height: 32px; padding: 0;"
                      title="Hapus" @click="store.deleteVoucher(v.SK)">
