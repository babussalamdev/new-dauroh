  ...
  <div class="container-fluid px-4 py-4">
    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mb-4 gap-3">
      <div>
        ...
        <CommonBreadcrumb :items="[{text: 'Dashboard', to: '/admin', icon: 'bi bi-house'}, {text: 'Informasi', to: '/admin/artikel'}, {text: 'Tambah Baru'}]" />
      </div>
    </div>
        ...
        <div class="sticky-sidebar">
          ...
          <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
            ...
            <div class="card-body p-3">
              <div class="Picture-container mx-auto position-relative rounded-3 overflow-hidden bg-light border border-dashed d-flex align-items-center justify-content-center">
                ...
                <div v-else class="text-muted p-4 text-center">
                  ...
                  <div class="txt-caption mt-2">Pilih Gambar Utama</div>
                </div>
            ...
            <div class="d-flex gap-2 px-3 pb-3">
              <label for="posterUploadArticle" class="btn btn-sm btn-light txt-body fw-bold w-100 text-primary border">
          ...
          <div class="card border-0 shadow-sm rounded-4 p-4 mb-4 bg-white">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control modern-input txt-body fw-bold" v-model="form.Title" placeholder="Ketik judul artikel..." required>
            </div>
      ...
      <div class="col-lg-8 col-xl-9">
        ...
        <section class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
          ...
          <div class="px-4 py-3 bg-white border-top d-flex justify-content-end gap-2">
            ...
            <button @click="handleSaveArticle" class="btn btn-primary rounded-pill px-4 txt-body fw-bold" :disabled="isSaving">
