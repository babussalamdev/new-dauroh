          ...
          <form @submit.prevent="handleLogin">
            <div class="mb-3">
              ...
              <input type="text" id="username" v-model="form.email" placeholder="Masukkan username atau email"
                class="form-control form-control-lg" :disabled="loading" required />
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="password-wrapper">
                <input :type="showPassword ? 'text' : 'password'" v-model="form.password" id="password"
                  placeholder="Masukkan password" class="form-control form-control-lg" :disabled="loading" required />
