export default defineNuxtConfig({
  ...
  plugins: ["~/plugins/axios.ts", { src: "~/plugins/bootstrap.client.ts", mode: "client" }],

  css: ["bootstrap/dist/css/bootstrap.min.css", "@/assets/css/variables.scss"],
  app: {
    head: {
      script: [
        ...
        {
          innerHTML: `window.gtranslateSettings = {"default_language":"id","languages":["id","ar","en"],"wrapper_selector":".gtranslate_wrapper","flag_size":24,"switcher_horizontal_position":"inline","flag_style":"3d"}`,
